...
class Command(BaseCommand):
    ...
    def handle(self, app=None, name="", added_model_list=None, added_field_list=None, initial=False, freeze_list=None, auto=False, stdout=False, added_index_list=None, verbosity=1, **options):
        ...
        file_contents = MIGRATION_TEMPLATE % {
            "forwards": forwards, 
            "backwards": backwards, 
            "frozen_models": pprint_frozen_models(all_models),
